...
def test_training_produces_artifacts():
    ...
    artifacts = train.run_training_pipeline(
        ...
        models_dir=str(repo / "outputs" / "models"),
...
def test_intelligence_creates_summary():
    ...
    import importlib
    analyze = importlib.import_module("analytics.analyze")
...
def test_agent_writes_forecast_json():
    ...
    import importlib
    agent = importlib.import_module("coach.agent")
...
def test_prediction_tracking_roundtrip():
    ...
    tracking = importlib.import_module("analytics.prediction_tracking")
