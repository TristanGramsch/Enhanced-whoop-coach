...
from analytics.prediction_tracking import append_next_day_prediction, reconcile_with_actuals  # type: ignore
...
def main():
    ...
    outputs_dir = Path(outputs_dir_env) if outputs_dir_env else outputs_root
